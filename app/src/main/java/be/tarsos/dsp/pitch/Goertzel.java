...
public class Goertzel implements AudioProcessor {
    ...
    private static double POWER_THRESHOLD = 10;// in dB
	...
	public Goertzel(final float audioSampleRate, final int bufferSize,
			double[] frequencies, FrequenciesDetectedHandler handler, float t_power_threshold) {

		POWER_THRESHOLD = t_power_threshold;
